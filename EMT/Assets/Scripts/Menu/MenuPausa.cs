...
public class MenuPausa : MonoBehaviour
{
    ...
    // Propiedad p�blica para que otros scripts sepan si el juego est� en pausa
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogWarning("M�ltiples instancias de MenuPausa encontradas, destruyendo la nueva");
            Destroy(gameObject);
        }
    }
    ...
    private void OnEnable()
    {
        ...
        {
            Debug.LogError("MenuPausa: No se asign� la acci�n de pausa en el Inspector!");
        }
    }
    ...
    private void OnPausaPressed(InputAction.CallbackContext context)
    {
        ...
        {
            // No pausar mientras el tutorial esté abierto
    ...
    private void Start()
    {
        ...
        {
            Debug.LogError("MenuPausa: No se encontr� VolumeController en la escena!");
        }
        else
        {
        ...
        {
            Debug.LogWarning("MenuPausa: No se encontr� PlayerAtaque en la escena!");
        }
        else
        {
        ...
        if (audioMixer == null)
        {
            Debug.LogError("MenuPausa: No se asign� el AudioMixer en el Inspector!");
        }
        else
        {
        ...
        {
            Debug.LogWarning("MenuPausa: No se encontr� RhythmGameManager en la escena!");
        }
        else
        {
    ...
    public void PausarJuego()
    {
        ...
        // Forzar desactivaci�n del cubo de ataque si est� visible
        if (playerAtaque != null)
        {
    ...
    {
        Debug.Log("Volviendo al Men� de Inicio...");
        ...
        if (SistemaPuntuacion.Instance != null)
        {
            ...
            Debug.Log("Score reiniciado al volver al men� principal. Highscore se mantiene.");
        }
